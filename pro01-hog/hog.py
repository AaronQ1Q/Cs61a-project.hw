...
def swine_align(player_score, opponent_score):
    ...
    if(player_score==0 or opponent_score==0):
        return False
    min1=min(player_score,opponent_score)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def commentary(score,score1,last_score=last_score,running_high=running_high):
        if who==0:
